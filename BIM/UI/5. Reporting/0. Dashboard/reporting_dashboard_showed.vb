...
Public Class reporting_dashboard_showed
...
#Region "behaviors"
    ...
    Private Sub calendar_changed(sender As Object, e As EventArgs) Handles txt_sales_date.EditValueChanged
        If txt_sales_date.EditValue IsNot Nothing Then
            Dim criteria_search As String = "month(s.date_sale)=" & Month(txt_sales_date.EditValue) & " and year(s.date_sale)=" & Year(txt_sales_date.EditValue) & " and s.row_visible=1 and s.segment_code=" & rgo_object_segment.EditValue
            Dim criteria_budget As String = "b.validity_month=" & Month(txt_sales_date.EditValue) & " and b.validity_year=" & Year(txt_sales_date.EditValue) & "  and b.row_visible=1"
