...
Public Class reports_wholesales_segment
...
#Region "methods"
    Private Sub seach_option(sender As Object, e As EventArgs) Handles btn_object_find.Click
            ...
            If criteria_condition() <> "" Then
                ...
                If source.Rows.Count > 0 Then
                    With crv_object_report
                        ...
                        .LocalReport.ReportEmbeddedResource = "BIM.reports_wholesales_segment.rdlc"
                        .RefreshReport()
                    End With
                End If
            Else
