...
Public Class commision_searched_discount
...
#Region "behaviors"
    ...
    Public Sub reports_show(Optional criteria_search As String = "")
        Dim source As DataTable = commision.commision_discount_search(criteria_search)
        ...
        If source.Rows.Count > 0 Then
            ...
            With dgv_object_view
                ...
                .Columns("value_discount").Visible = False
                .BestFitColumns(True)
                .SelectRow(0)
...
#Region "helpers"
    Private Sub objects_condition()
        ...
        txt_rules_criteria.FilterColumns.Add(New UnboundFilterColumn("Fecha de registro", "convert(date,d.event_date)", GetType(Date), New RepositoryDate, FilterColumnClauseClass.DateTime))
        ...
        txt_rules_criteria.FilterColumns.Add(New UnboundFilterColumn("Tipo de descuento", "d.discount_code", GetType(Integer), New RepositoryListed(commision.commision_discount_type("row_visible=1"), "discount_name"), FilterColumnClauseClass.Lookup))
    End Sub
            ...
            If message_text("Está seguro que desea eliminar los registros seleccionados?", MessageBoxButtons.YesNo) = DialogResult.Yes Then
                For i As Integer = 0 To dgv_object_view.DataRowCount - 1
                    If dgv_object_view.IsRowSelected(i) = True Then
                        commision.commision_discount_erased_option(dgv_object_view.GetRowCellValue(i, "Id"), False)
                    End If
                Next
