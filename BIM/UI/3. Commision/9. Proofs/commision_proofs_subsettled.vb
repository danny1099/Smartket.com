...
Public Class commision_proofs_subsettled
...
#Region "behaviors"
    Private Sub objects_condition()
        ...
        txt_rules_criteria.FilterColumns.Add(New UnboundFilterColumn("Nombre de pagador", "p.person_code", GetType(Integer), New RepositoryListed(person.settings_persons_listed("p.row_visible=1"), "Nombre del funcionario"), FilterColumnClauseClass.Lookup))
    ...
    Private Sub saved_option(sender As Object, e As EventArgs) Handles btn_object_find.Click
        ...
        Else
            If criteria_condition() <> "" Then
                ...
                Dim source As DataTable = commision.commision_subpayments_proofs(criteria_condition)
