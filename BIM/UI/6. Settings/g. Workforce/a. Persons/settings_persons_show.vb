...
Public Class settings_persons_show
    Private person As Persons = Persons.Instance
    Private criteria_search As String = "p.row_visible=1"
...
#Region "behaviors"
    ...
    Public Sub reports_show(Optional criteria_search As String = "")
        Dim source As DataTable = person.settings_persons_show(criteria_search)
    ...
    Private Sub selected_resumen(sender As Object, e As EventArgs) Handles dgv_object_grid.DoubleClick
        If dgv_object_view.IsRowSelected(dgv_object_view.FocusedRowHandle) = True Then
            show_option(New settings_persons_resume(dgv_object_view.GetRowCellValue(dgv_object_view.FocusedRowHandle, "Id")))
        End If
    End Sub
...
#Region "options"
    Private Sub create_option(sender As Object, e As EventArgs) Handles btn_object_new.Click
        show_option(New settings_persons_create)
    End Sub
    ...
    Private Sub edited_option(sender As Object, e As EventArgs) Handles btn_object_edit.Click
        If dgv_object_view.SelectedRowsCount.ToString = 1 Then
            If message_text("Está seguro que desea modificar el registro seleccionado?", MessageBoxButtons.YesNo) = DialogResult.Yes Then
                show_option(New settings_persons_edited(dgv_object_view.GetRowCellValue(dgv_object_view.FocusedRowHandle, "Id")))
            End If
        Else
            ...
            If message_text("Está seguro que desea eliminar los registros seleccionados?", MessageBoxButtons.YesNo) = DialogResult.Yes Then
                For i As Integer = 0 To dgv_object_view.DataRowCount - 1
                    If dgv_object_view.IsRowSelected(i) = True Then
                        person.settings_persons_erase(dgv_object_view.GetRowCellValue(i, "Id"), False)
                    End If
                Next
    ...
    Private Sub resume_option(sender As Object, e As EventArgs) Handles btn_object_resume.Click
        If dgv_object_view.SelectedRowsCount.ToString = 1 Then
