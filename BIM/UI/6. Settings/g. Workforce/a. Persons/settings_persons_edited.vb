Public Class settings_persons_edited
...
#Region "behaviors"
        ...
        If sessions.admin_user <> 1 Then
            ...
            If table.Rows.Count > 0 Then
                With table
                    ...
                    If table.Select("action_name='txt_employee_document' and object_show='" & Me.Name & "'").Count = 0 Then
                        txt_employee_document.Properties.ReadOnly = False
                    End If

                    If table.Select("action_name='txt_employee_name' and object_show='" & Me.Name & "'").Count = 0 Then
                        txt_employee_name.Properties.ReadOnly = False
                    End If
                End With
            End If
        End If
    ...
    Private Sub search_person()
        ...
        If table.Rows.Count = 1 Then
            With table.Rows(0)
                cmb_employee_document.EditValue = cmb_employee_document.Properties.GetKeyValueByDisplayText(.Item("alias_document").ToString)
                txt_employee_document.EditValue = .Item("number_document").ToString
    ...
    Private Sub saved_option(sender As Object, e As EventArgs) Handles btn_object_accept.Click
        If xvp_validate.Validate = True Then
            With person.sql_command
                ...
                .CommandText = "entities_workforce_persons_edited"
