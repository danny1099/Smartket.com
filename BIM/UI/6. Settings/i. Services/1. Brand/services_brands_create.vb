Public Class services_brands_create
    ...
    Private Sub saved_option(sender As Object, e As EventArgs) Handles btn_object_accept.Click
        If xvp_validate.Validate = True Then
            With brand.sql_command
                ...
                .CommandText = "entities_products_brands_create"

                .Parameters.Clear()
                .Parameters.Add("@brand_name", SqlDbType.VarChar, 50).Value = txt_brand_name.EditValue
