Public Class services_products_objects
    ...
    Private Sub saved_option(sender As Object, e As EventArgs) Handles btn_object_accept.Click
        If xvp_validate.Validate = True Then
            With parameter.sql_command
                ...
                .CommandText = rgo_type_features.EditValue

                .Parameters.Clear()
                .Parameters.Add("@object_name", SqlDbType.VarChar, 50).Value = txt_category_name.EditValue
