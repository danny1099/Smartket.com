...
Public Class settings_dealers_show
...
#Region "constructor"
    Public Sub New()
        ...
        'aplica los permisos del modulo
        search_permits()
    End Sub
...
#Region "behaviors"
    ...
    Public Sub reports_show(Optional criteria_search As String = "")
        Dim source As DataTable = dealer.settings_dealers_search(criteria_search)
        ...
        If source.Rows.Count > 0 Then
            ...
            With dgv_object_view
                ...
                .Columns("operator_code").Visible = False
                .Columns("operator_name").Visible = False
                .Columns("siesa_code").Visible = False
...
#Region "options"
    ...
    Private Sub edited_option(sender As Object, e As EventArgs) Handles btn_object_edit.Click
        If dgv_object_view.SelectedRowsCount.ToString = 1 Then
            If message_text("Está seguro que desea modificar el registro seleccionado?", MessageBoxButtons.YesNo) = DialogResult.Yes Then
                Using edit_ As New settings_dealers_edited(dgv_object_view.GetRowCellValue(dgv_object_view.FocusedRowHandle, "Id"))
            ...
            If message_text("Está seguro que desea eliminar los registros seleccionados?", MessageBoxButtons.YesNo) = DialogResult.Yes Then
                For i As Integer = 0 To dgv_object_view.DataRowCount - 1
                    If dgv_object_view.IsRowSelected(i) = True Then
                        dealer.settings_dealers_erase(dgv_object_view.GetRowCellValue(i, "Id"), False)
                    End If
                Next
    ...
    Private Sub agency_option(sender As Object, e As EventArgs) Handles btn_object_agencys.Click
        If dgv_object_view.SelectedRowsCount.ToString = 1 Then
            If message_text("Está seguro que desea asignar agencias al registro seleccionado?", MessageBoxButtons.YesNo) = DialogResult.Yes Then
                Using edit_ As New dealers_assign_show(dgv_object_view.GetRowCellValue(dgv_object_view.FocusedRowHandle, "Id"))
                    edit_.ShowDialog(start_home)
                End Using
            End If
        Else
