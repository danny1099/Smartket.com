Public Class settings_operators_edited
...
#Region "behaviors"
    Private Sub search_object()
        Dim table As DataTable = operators.settings_operators_search("Id=" & record_affected)

        If table.Rows.Count = 1 Then
            With table.Rows(0)
                txt_operator_name.EditValue = .Item("operator_name").ToString
...
#Region "methods"
    Private Sub saved_option(sender As Object, e As EventArgs) Handles btn_object_accept.Click
        If xvp_validate.Validate = True Then
            With operators.sql_command
                .CommandType = CommandType.StoredProcedure
                .CommandText = "entities_bussines_operator_edited"

                .Parameters.Clear()
                .Parameters.Add("@row_affected", SqlDbType.TinyInt).Value = record_affected
                .Parameters.Add("@operator_name", SqlDbType.VarChar, 50).Value = txt_operator_name.EditValue
            ...
            If operators.execute_procedure = True Then
                Close()
            End If
        End If
    End Sub
