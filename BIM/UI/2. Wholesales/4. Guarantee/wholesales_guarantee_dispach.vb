Public Class wholesales_guarantee_dispach
    ...
    Private Sub saved_option(sender As Object, e As EventArgs) Handles btn_object_accept.Click
        If xvp_validate.Validate = True Then
            With guarantee.sql_command
                ...
                .CommandText = "wholesales_master_guarantee_dispach"

                .Parameters.Clear()
                .Parameters.Add("@row_affected", SqlDbType.Int).Value = record_affected
                .Parameters.Add("@dispach_number", SqlDbType.VarChar, 50).Value = txt_dispatch_number.EditValue
