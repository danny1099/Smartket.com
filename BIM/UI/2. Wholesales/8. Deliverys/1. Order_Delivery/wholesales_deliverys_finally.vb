Public Class wholesales_deliverys_finally
    ...
    Private Sub saved_option(sender As Object, e As EventArgs) Handles btn_object_accept.Click
        If xvp_validate.Validate = True Then
            With delivery.sql_command
                ...
                .CommandText = "wholesales_master_sending_closed"

                .Parameters.Clear()
                .Parameters.Add("@row_affected", SqlDbType.Int).Value = record_affected
                .Parameters.Add("@dispatch_number", SqlDbType.VarChar, 50).Value = txt_number_document.Text
