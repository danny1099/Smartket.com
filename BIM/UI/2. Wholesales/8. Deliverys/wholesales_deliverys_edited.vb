...
Public Class wholesales_deliverys_edited
    ...
    Private Sub search_object()
        ...
        If table_search.Rows.Count = 1 Then
            With table_search.Rows(0)
                cmb_delivery_person.EditValue = CInt(.Item("person_code"))
                cmb_delivery_agency.EditValue = cmb_delivery_agency.Properties.GetKeyValueByDisplayText(.Item("agency_destiny"))
                txt_deliverys_status.EditValue = .Item("status_name")
    ...
    Private Sub saved_option(sender As Object, e As EventArgs) Handles object_button_accept.Click
        If xvp_validate.Validate = True And dgv_object_view.RowCount > 0 Then
            With delivery.sql_command
                ...
                .CommandText = "wholesales_master_deliverys_edited"

                .Parameters.Clear()
                .Parameters.Add("@record_affected", SqlDbType.Int).Value = record_affected
