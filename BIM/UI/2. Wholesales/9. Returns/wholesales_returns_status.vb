Public Class wholesales_returns_status
    Private returns As Returns = Returns.Instance
    Private parameters_ As Parameters = Parameters.Instance
    ...
    Private Sub search_object()
        ...
        If table_search.Rows.Count = 1 Then
            With table_search.Rows(0)
                ...
                txt_returns_number.EditValue = If(.Item("purchase_order").ToString = "", "0000000000", .Item("purchase_order").ToString)
            End With

            'Carga el listado de causales de cierre
            cmb_returns_status.Datasources(parameters_.settings_search_status("row_visible=1 and  s.Id not in (19) and s.module_type='R'"), "status_name")
        End If
    End Sub
    ...
    Private Sub saved_option(sender As Object, e As EventArgs) Handles btn_object_accept.Click
        If xvp_validate.Validate = True Then
            With returns.sql_command
                ...
                .CommandText = "wholesales_master_returns_status"

                .Parameters.Clear()
                .Parameters.Add("@row_affected", SqlDbType.Int).Value = record_affected
                .Parameters.Add("@status_code", SqlDbType.SmallInt).Value = cmb_returns_status.EditValue
