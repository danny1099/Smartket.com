...
Public Class wholesales_returns_viewer
...
#Region "contructors"
    ...
    Private Sub search_data()
        If record_affected <> 0 Then
            ...
            Dim source As DataTable = returns_.wholesale_returns_format(record_affected)

            'check if source have rows to show
            If source.Rows.Count > 0 Then
                Dim report_settled As New wholesales_returns_format
