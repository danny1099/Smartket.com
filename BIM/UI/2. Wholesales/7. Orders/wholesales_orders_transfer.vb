Public Class wholesales_orders_transfer
    Private person As Persons = Persons.Instance
    Private order As Orders = Orders.Instance
...
#Region "methods"
    Private Sub saved_option(sender As Object, e As EventArgs) Handles btn_object_accept.Click
        If xvp_validate.Validate = True Then
            With order.sql_command
                .CommandType = CommandType.StoredProcedure
                .CommandText = "wholesales_master_orders_transfer"
            ...
            If order.execute_procedure(True) = True Then
                Close()
            End If
        End If
    End Sub
