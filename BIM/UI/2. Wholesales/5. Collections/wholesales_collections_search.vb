...
Public Class wholesales_collections_search
...
#Region "behaviors"
    Private Sub objects_condition()
        txt_rules_criteria.FilterColumns.Add(New UnboundFilterColumn("Fecha de creación", "c.date_collection", GetType(Date), New RepositoryDate, FilterColumnClauseClass.DateTime))
        txt_rules_criteria.FilterColumns.Add(New UnboundFilterColumn("Concepto", "c.concept_code", GetType(Integer), New RepositoryChecked(collection.wholesale_collections_concepts("row_visible=1"), "concept_name"), FilterColumnClauseClass.Lookup))
        ...
        txt_rules_criteria.FilterColumns.Add(New UnboundFilterColumn("Cantidad", "p.collection_ammount", GetType(Integer), New RepositoryItemTextEdit, FilterColumnClauseClass.String))
        txt_rules_criteria.FilterColumns.Add(New UnboundFilterColumn("Valor Recaudado", "p.collection_values", GetType(Integer), New RepositoryItemTextEdit, FilterColumnClauseClass.String))
    End Sub
