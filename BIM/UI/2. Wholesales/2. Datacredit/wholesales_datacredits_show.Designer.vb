...
Partial Class wholesales_datacredits_show
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(wholesales_datacredits_show))
    ...
    "*"
        ...
        Me.lbl_module_title.Text = "Datacreditos"
        '
        'btn_object_close
        '
        ...
        Me.lbl_object_today.Tag = "convert(date,c.event_date)=convert(date,getdate())"
        ...
        Me.lbl_object_lastday.Tag = "convert(date,c.event_date)=convert(date,dateadd(day,-1,getdate()))"
        ...
        Me.lbl_object_month.Tag = "month(c.event_date)=month(dateadd(month,-1,getdate())) and year(c.event_date)=yea" &
    "r((select case when month(dateadd(month,-1,getdate()))=12 then dateadd(year,-1,g" &
    "etdate()) else getdate() end))"
        ...
        '
        'wholesales_datacredits_show
        '
        Me.AccessibleName = "WD001S"
        ...
        Me.Name = "wholesales_datacredits_show"
