...
Public Class comercial_attention_transfer
...
#Region "contructors"
    ...
    Public Sub New(row_selected_ As Integer)
        ...
        'set in private variable parameter
        row_selected = row_selecteds(row_selected_)
    End Sub
...
#Region "behaviors"
    ...
    Private Function row_selecteds(row_selected_ As Integer) As List(Of Integer)
        Dim rows_listed As New List(Of Integer)
        rows_listed.Add(row_selected_)
        ...
        If xvp_validate.Validate = True Then
            For Each row_affected As Integer In row_selected
                With attention.sql_command
                    ...
                    .CommandText = "relationship_comercial_attention_transfer"
            ...
            If message_text("Las gestiones fueron transferidas exitosamente", MessageBoxButtons.OK) = DialogResult.OK Then
                Close()
            End If
        End If
    End Sub
