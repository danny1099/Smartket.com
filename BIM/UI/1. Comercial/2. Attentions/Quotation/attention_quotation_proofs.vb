...
Public Class attention_quotation_proofs
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "attention_quotation_proofs.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BIM.attention_quotation_proofs.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedattention_quotation_proofs
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As attention_quotation_proofs = New attention_quotation_proofs()
        rpt.Site = Me.Site
        Return rpt
    End Function
