Public Class comercial_customer_create
...
#Region "behaviors"
    Private Sub object_listed()
        ...
        cmb_customer_person.Datasources(person.settings_persons_listed("p.agency_code in (" & sessions.agency_permit & ") and p.row_visible=1"), "Nombre del funcionario")
    End Sub
    ...
    Private Sub search_document(sender As Object, e As EventArgs) Handles txt_customer_document.Leave
        If txt_customer_document.Text <> "" Then search_person()
    End Sub

    Private Sub validate_options(sender As Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles txt_customer_document.ButtonClick
        If e.Button.Kind = DevExpress.XtraEditors.Controls.ButtonPredefines.Search And txt_customer_document.Text <> "" Then search_person()
    End Sub
    ...
    Private Sub search_person()
        Dim table As DataTable = customer.comercial_customer_search("c.number_document='" & txt_customer_document.Text & "'")
        ...
        If table.Rows.Count >= 1 Then
            With table.Rows(0)
                ...
                cmb_customer_source.EditValue = cmb_customer_source.Properties.GetKeyValueByDisplayText(.Item("knowledge_name").ToString)
                ...
                btn_object_accept.Enabled = False
            ...
            End With
        Else
            btn_object_accept.Enabled = True
        End If
    End Sub
    ...
    Private Sub saved_option(sender As Object, e As EventArgs) Handles btn_object_accept.Click
        If xvp_validate.Validate = True Then
            With customer.sql_command
                ...
                .CommandText = "relationship_customer_person_created"
