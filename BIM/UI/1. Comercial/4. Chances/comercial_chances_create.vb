...
Public Class comercial_chances_create
    ...
    Private Sub saved_option(sender As Object, e As EventArgs) Handles btn_object_accept.Click
        If xvp_validate.Validate = True Then
            With chance.sql_command
                ...
                .CommandText = "relationship_customer_chance_create"
            ...
            If chance.execute_procedure = True Then
                If chk_keep_form.Checked = True Then
                    If chk_object_global.Checked = False Then defaults_objects(pnl_object_container)
                Else
