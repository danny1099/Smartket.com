...
Public Class comercial_chances_show
...
#Region "behaviors"
    ...
    Public Sub reports_show(Optional criteria_search As String = "")
        Dim source As DataTable = chances.commercial_chances_show(criteria_search)
        ...
        If source.Rows.Count > 0 Then
            ...
            With dgv_object_view
                ...
                .Columns("condition_text").Visible = False
                .Columns("condition_object").Visible = False
                .Columns("segment_code").Visible = False
                .Columns("Encontradas").AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
                .Columns("Tomadas").AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center
...
#Region "options"
    Private Sub create_option(sender As Object, e As EventArgs) Handles btn_object_new.Click
        show_option(New comercial_chances_create)
    End Sub
    ...
    Private Sub edited_option(sender As Object, e As EventArgs) Handles btn_object_edit.Click
        If dgv_object_view.SelectedRowsCount.ToString = 1 Then
            If message_text("Está seguro que desea modificar el registro seleccionado?", MessageBoxButtons.YesNo) = DialogResult.Yes Then
                show_option(New comercial_chances_edited(dgv_object_view.GetRowCellValue(dgv_object_view.FocusedRowHandle, "Id")))
            End If
        Else
            ...
            If message_text("Está seguro que desea eliminar los registros seleccionados?", MessageBoxButtons.YesNo) = DialogResult.Yes Then
                For i As Integer = 0 To dgv_object_view.DataRowCount - 1
                    If dgv_object_view.IsRowSelected(i) = True Then
                        chances.commercial_chances_erase(dgv_object_view.GetRowCellValue(i, "Id"), False)
                    End If
                Next
    ...
    Private Sub search_option(sender As Object, e As EventArgs) Handles btn_object_view.Click
        If dgv_object_view.SelectedRowsCount.ToString = 1 Then
            Using view_ As New comercial_chances_viewer(dgv_object_view.GetRowCellValue(dgv_object_view.FocusedRowHandle, "condition_object"), dgv_object_view.GetRowCellValue(dgv_object_view.FocusedRowHandle, "segment_code"))
